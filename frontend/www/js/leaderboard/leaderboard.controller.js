(function()
{
  ...
  function LeaderboardController($scope, localStorage, $ionicSlideBoxDelegate, PlayerService, SettingsService, BadgesService) {
    ...
    function getStats() {
      ...
      // load from server
      PlayerService.updatePlayers('active').then(function successCallback(response) {
